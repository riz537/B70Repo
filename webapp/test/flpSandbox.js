		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "B70 SAPUI5 Application",
									"targetURL": "#comdemob70ui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemob70ui5app-display": {
								"semanticObject": "comdemob70ui5app",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.b70ui5app",
									"url": sap.ui.require.toUrl("com/demo/b70ui5app")
								}
							}
						}
					}
